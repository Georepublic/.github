# Contributing to Georepublic
We want to make contributing to this project as approachable and transparent as
possible.

## Code of Conduct
Georepublic has adopted a Code of Conduct that we expect project
participants to adhere to. Please [read the full text](https://github.com/georepublic/.github/blob/master/CODE_OF_CONDUCT.md)
...
Before we can include your contribution in the Georepublic project, you need to 
...
## License
By contributing to Georepublic, you agree that your contributions will be licensed
